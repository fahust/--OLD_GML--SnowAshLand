/* SL_engine_render();                       */
/* Calcule l'ensemble des ombres et lumi̬res */
...
// Calcul de la puissance de l'̩clairage ambiant
...
if room = room131 {global.sl_ambient_light = 0.1}
if room = room132 {global.sl_ambient_light = 0.1}
/// - MASKS
if obj_zombie.lowgpu2 = 6 {}else{
draw_set_alpha(1);
draw_set_blend_mode(bm_normal);
  

for (i1=0; i1<sl_layers_count; i1+=1)//for (i1=0; i1<sl_layers_count; i1+=1)
{
    ...
    surface_set_target(sl_layers_surface[i1]); // Cr̩ation des masks pour le rendu des layers
    draw_clear(c_white);
...
if sl_sunshadows_refresh && sl_sunshadows_refreshcounter<=0
{
    ...
    if sl_sunshadows_light < 1
    {
        ...
        {
            surface_set_target(sl_sunshadows_surface1[0]); // Cr̩ation du sample
            draw_clear(c_white);
...
// Calcul des composantes de la lumi̬re ambiante
if sl_tod_active
{
...
// R̩initialisation des listes des sprites affich̩es dans le buffer
